...
when users this i got both experience and inexperience users to test the application. this was done by first asking them if they've had experience with Co-Operation, YAML, or modding in general. once i had determined this i then got them to complete a set of tasks which uses the application\refImage{tasksList}. this is so that they could more easily complete the questionnaire i provide and make sure they use all the features I am testing (figures \ref{fig:baseSurvey1}-\ref{fig:baseSurvey5}). the only form of recording was through questionnaires and so the identity of the participates are completely anonymous. however i can say that the participates are Friends, family and university college that have given verbal agreement to test and give feedback on my application.
